...
dataset = dict(
    train=dict(
        ...
        dataset_dir='/data2/NCUT/个人文件夹/HJH/北理项目/competition/1/dataset/1_1024_256/preprocessed/train_1024_200_1.0',
        transforms=[
            dict(
    ...
    test=dict(
        type="ImageDataset",
        images_dir='/data2/NCUT/个人文件夹/HJH/北理项目/competition/1/dataset/1_1024_256/preprocessed/test_1024_200_1.0/images/',
        transforms=[
            dict(
                type="RotatedResize",
                min_size=1024,

...
dataset = dict(
    train=dict(
        ...
        dataset_dir='/data2/NCUT/个人文件夹/HJH/北理项目/competition/1/dataset/ms_0.5_0.75_1_1.5_2_768_512/preprocessed/train_768_512_0.5-0.75-1.0-1.5-2',
        transforms=[
            dict(
    ...
    test=dict(
        type="ImageDataset",
        images_dir='/data2/NCUT/个人文件夹/HJH/北理项目/competition/1/dataset/ms_0.5_0.75_1_1.5_2_768_512/preprocessed/test_768_512_0.5-0.75-1.0-1.5-2/images/',
        transforms=[
            dict(
                type="RotatedResize",
                min_size=768,
...
optimizer = dict(type='SGD',  lr=0.01, momentum=0.9, weight_decay=0.0001, grad_clip=dict(max_norm=35, norm_type=2))
